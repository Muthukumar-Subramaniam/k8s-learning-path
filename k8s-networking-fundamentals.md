...
│  │                        NETWORK OVERLAYS                                       │   │
│  │                                                                               │   │
│  │  📦 Node Network (10.10.20.0/22)    - Physical/VM network                    │     │
│  │  🌐 Pod Network (10.8.0.0/16)       - CNI-managed Pod-to-Pod                 │     │
│  │  ⚖️  Service Network (10.96.0.0/12) - Virtual IPs (kube-proxy)               │    │
│  │                                                                               │   │
│  │  Traffic: Client → Service:10.96.x.x → kube-proxy → Pod:10.8.x.x            │     │
│  │                                                                               │   │
│  └───────────────────────────────────────────────────────────────────────────────┘   │
│                                                                                      │
└──────────────────────────────────────────────────────────────────────────────────────┘
