...
│  ┌──────────────────────────────────────────────────────────────────────────────────────┐  │
│  │                            CONTROL PLANE NODE                                        │  │
│  │                            Node IP: 10.10.20.3 (Node Network)                        │  │
│  │                                                                                      │  │
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌────────────────┐  ┌──────────────┐ │     │
│  │  │  API Server      │  │  etcd            │  │  Scheduler     │  │  Controller  │ │     │
│  │  │  :6443           │  │  :2379-2380      │  │                │  │  Manager     │ │     │
│  │  │                  │  │                  │  │                │  │              │ │     │
│  │  │ • Services       │  │ • Cluster State  │  │ • Pod          │  │ • Node Ctrl  │ │     │
│  │  │ • Endpoints      │  │ • Network Config │  │   Scheduling   │  │ • Replication│ │     │
...
│  │  │  :53            │  │  (Control Logic) │                               │         │    │
│  │  │                 │  │                  │                               │         │    │
│  │  │ • Service DNS   │  │ • IPAM Config    │                               │         │    │
│  │  │ • Pod DNS       │  │ • Network Policy │                               │         │    │
│  │  └─────────────────┘  └──────────────────┘                               │         │    │
│  │                                                                           │         │   │
│  └───────────────────────────────────────────────────────────────────────────┼─────────┘   │
│                                                                              │             │
...
│  ┌──────────────────────────────────┼────────────────────────────────────────┼─────────┐   │
│  │                   WORKER NODE 1                                          │         │    │
│  │                   Node IP: 10.10.20.4 (Node Network)                     │         │    │
│  │                   Pod CIDR: 10.8.0.0/24 (Pod Network)                    │         │    │
│  │                                                                           │         │   │
│  │  ┌────────────────────────────────────────────────────────────────────────┼─────┐  │    │
│  │  │  kubelet                                                               │     │  │    │
│  │  │  • Manages Pods                                                        │     │  │    │
...
│  │  │  (DaemonSet)    │                                   │  (Calico/Flannel)│         │   │
│  │  │                 │                                   │                  │         │   │
│  │  │ Mode: iptables  │                                   │ • Pod Networking │         │   │
│  │  │ • Service Rules │                                   │ • IPAM           │         │   │
│  │  │ • Load Balance  │                                   │ • Routes         │         │   │
...
│  │  │                                                                       │          │   │
│  │  │  ┌──────────────┐  ┌─────────────┐  ┌──────────────┐  ┌─────────┐  │          │      │
│  │  │  │  iptables    │  │  Routing    │  │  cni0        │  │  veth   │  │          │      │
│  │  │  │  NAT Rules   │  │  Tables     │  │  Bridge      │  │  pairs  │  │          │      │
│  │  │  │              │  │             │  │  10.8.0.1    │  │         │  │          │      │
│  │  │  │• KUBE-SVC    │  │• Pod Routes │  │              │  │vethXXXX │  │          │      │
│  │  │  │• KUBE-SEP    │  │• Node Routes│  │              │  │         │  │          │      │
│  │  │  └──────────────┘  └─────────────┘  └──────┬───────┘  └─────┬───┘  │          │      │
│  │  │                                             │               │       │          │     │
│  │  └─────────────────────────────────────────────┼───────────────┼───────┘          │     │
│  │                                                 │               │                  │    │
...
│  │  ┌──────────────────────────────────┐  ┌──────────────────────────────────┐      │      │
│  │  │  POD 1                           │  │  POD 2                           │      │      │
│  │  │  IP: 10.8.0.5                    │  │  IP: 10.8.0.8                    │      │      │
│  │  │                                  │  │                                  │      │      │
│  │  │  ┌────────────┐  ┌───────────┐  │  │  ┌───────────┐  ┌──────────┐    │      │        │
│  │  │  │ Pause      │  │ Container │  │  │  │ Container │  │ Container│    │      │        │
│  │  │  │ Container  │  │nginx:8080 │  │  │  │ app:3000  │  │ sidecar  │    │      │        │
│  │  │  │            │  │           │  │  │  │           │  │          │    │      │        │
│  │  │  │ • Holds    │  │ • App     │  │  │  │ • Backend │  │ • Logging│    │      │        │
│  │  │  │   Network  │  │   Logic   │  │  │  │   Service │  │ • Metrics│    │      │        │
│  │  │  │   Namespace│  │           │  │  │  │           │  │          │    │      │        │
│  │  │  └────────────┘  └───────────┘  │  │  └───────────┘  └──────────┘    │      │        │
│  │  │                                  │  │                                  │      │      │
...
│  │  └────────────────────────────────────────────────────────────────────────┘      │      │
│  │                                                                                   │     │
│  │  Physical NIC: eth0 (10.10.20.4) ◄──────── External Network ────────►           │       │
│  │                                                                                   │     │
│  └───────────────────────────────────────────────────────────────────────────────────┘     │
│                                                                                            │
│  ┌───────────────────────────────────────────────────────────────────────────────────┐     │
│  │                   WORKER NODE 2                                                   │     │
│  │                   Node IP: 10.10.20.5 (Node Network)                              │     │
│  │                   Pod CIDR: 10.8.1.0/24 (Pod Network)                             │     │
│  │                                                                                   │     │
│  │  [Similar structure: kubelet, kube-proxy, CNI, Pods with IPs 10.8.1.x]           │      │
│  │                                                                                   │     │
│  │  Physical NIC: eth0 (10.10.20.5) ◄──────── External Network ────────►           │       │
│  │                                                                                   │     │
│  └───────────────────────────────────────────────────────────────────────────────────┘     │
│                                                                                            │
│  ┌───────────────────────────────────────────────────────────────────────────────────┐ │
│  │                        NETWORK OVERLAYS                                           │ │
│  │                                                                                   │ │
│  │  📦 Node Network (10.10.20.0/22)    - Physical/VM network for nodes              │ │
│  │  🌐 Pod Network (10.8.0.0/16)       - CNI-managed, Pod-to-Pod communication      │ │
│  │  ⚖️  Service Network (10.96.0.0/12) - Virtual IPs, kube-proxy managed            │ │
│  │                                                                                   │ │
│  │  Traffic Flow Example:                                                            │ │
│  │  Client → Service (10.96.100.50:80) → kube-proxy rules → Pod (10.8.0.5:8080)    │ │
│  │                                                                                   │ │
│  └───────────────────────────────────────────────────────────────────────────────────┘ │
│                                                                                        │
└────────────────────────────────────────────────────────────────────────────────────────┘
...
LEGEND:
  ...
  • Bullet points indicate key responsibilities
```
...
│           ▲                                                       │
│           │                                                       │
│           │ (3) Service translates ClusterIP → Pod IPs           │
│           │                                                       │
│  ┌────────┴──────────────────────────────────────┐               │
